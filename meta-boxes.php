	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
			...
			array(
				...
				'desc' => __('The number of calories in each serving.','rich-snippets'),
				'id'   => $prefix . 'recipes_nutrition',
				'class' => 'recipes',
				'type' => 'text_medium',
			),
			array(
				'name' => __('Keywords','rich-snippets'),
				'desc' => __('For example: "winter apple pie", "nutmeg crust".','rich-snippets'),
				'id'   => $prefix . 'recipes_keywords',
				'class' => 'recipes',
				'type' => 'text_medium',
			),
			array(
				'name' => __('Category','rich-snippets'),
				'desc' => __('For example: "dinner", "entree", or "dessert".','rich-snippets'),
				'id'   => $prefix . 'recipes_category',
				'class' => 'recipes',
				'type' => 'text_medium',
			),
			array(
				'name' => __('Cuisine','rich-snippets'),
				'desc' => __('For example: "French", Mediterranean", or "American".','rich-snippets'),
				'id'   => $prefix . 'recipes_cuisine',
				'class' => 'recipes',
				'type' => 'text_medium',
			),
			array(
			...
			array(
				'name' => __('Instruction Steps','rich-snippets'),
				'desc' => __('The steps to make the dish.','rich-snippets'),
				'id'   => $prefix . 'recipes_instructions',
				'class' => 'recipes',
				'type' => 'textarea_small',
			),
			array(
			...
			array(
				...
				'id'   => $prefix . 'recipes_video_thumb',
				'class' => 'recipes',
				'type' => 'file',
			),
			array(
				'name' => __('Video URL','rich-snippets'),
			...
			array(
				...
				'desc' => __('A URL pointing to a player for the specific video. Usually this is the information in the src element of an &lt;embed&gt;tag. <br>Example: <br>Youtube: https://www.youtube.com/embed/CibazcCevOk <br>Dailymotion: http://www.dailymotion.com/swf/x1o2g<br><div class="bsf_vd_note"><h4>Add only one url either in "Video" or "Embed Video" field. Dont use both.</h4></div>','rich-snippets'),
				'id'   => $prefix . 'recipes_video_emb_url',
				'class' => 'recipes',
				'type' => 'text',
			),
			...
			array(
				...
				'id'   => $prefix . 'recipes_video_duration',
				'class' => 'recipes',
				'type' => 'text_small',
			),
			array(
